...
class CategoryProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create category_project" do
    assert_difference('CategoryProject.count') do
      post category_projects_url, params: { category_project: { category_id: @category_project.category_id, project_id: @category_project.project_id } }
    end
  ...
  test "should update category_project" do
    patch category_project_url(@category_project), params: { category_project: { category_id: @category_project.category_id, project_id: @category_project.project_id } }
